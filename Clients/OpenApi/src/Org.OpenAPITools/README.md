...
inputSpec: openwebui.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{16024733-B508-40FC-AE1A-BB3EECF7092F}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAudioApi>();
            IGetAudioConfigApiV1AudioConfigGetApiResponse apiResponse = await api.GetAudioConfigApiV1AudioConfigGetAsync("todo");
