...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Input : IValidatableObject
    {
        ...
        internal Input(Option<List<string>?> list, Option<string?> @string)
        {
            ListOption = list;
            StringOption = @string;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="Input" />
    /// </summary>
    public class InputJsonConverter : JsonConverter<Input>
    {
        /// <summary>
        /// Deserializes json to <see cref="Input" />
        /// </summary>
        ...
        public override Input Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Input(listParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Input" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="input"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Input input, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (input.ListOption.IsSet && input.ListOption.Value != null)

            if (input.StringOption.IsSet && input.StringOption.Value != null)
                writer.WriteString("Metadata", input.StringOption.Value);

            WriteProperties(writer, input, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Input" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="input"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Input input, JsonSerializerOptions jsonSerializerOptions)
        {
