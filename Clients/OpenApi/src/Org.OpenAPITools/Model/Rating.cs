...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Rating : IValidatableObject
    {
        ...
        internal Rating(Option<int?> @int, Option<string?> @string)
        {
            IntOption = @int;
            StringOption = @string;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="Rating" />
    /// </summary>
    public class RatingJsonConverter : JsonConverter<Rating>
    {
        /// <summary>
        /// Deserializes json to <see cref="Rating" />
        /// </summary>
        ...
        public override Rating Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Rating(varIntParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Rating" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rating"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Rating rating, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (rating.IntOption.IsSet && rating.IntOption.Value != null)
                writer.WriteNumber("Size", rating.IntOption.Value.Value);

            if (rating.StringOption.IsSet && rating.StringOption.Value != null)
                writer.WriteString("Rating", rating.StringOption.Value);

            WriteProperties(writer, rating, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Rating" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rating"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Rating rating, JsonSerializerOptions jsonSerializerOptions)
        {
