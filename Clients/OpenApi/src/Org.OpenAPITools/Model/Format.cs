...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Format : IValidatableObject
    {
        ...
        internal Format(Option<Object?> @object, Option<string?> @string)
        {
            ObjectOption = @object;
            StringOption = @string;
            OnCreated();
    ...
    /// <summary>
    /// A Json converter for type <see cref="Format" />
    /// </summary>
    public class FormatJsonConverter : JsonConverter<Format>
    {
        /// <summary>
        /// Deserializes json to <see cref="Format" />
        /// </summary>
        ...
        public override Format Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Format(varObjectParsedValue, varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Format" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="format"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Format format, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (format.ObjectOption.IsSet && format.ObjectOption.Value != null)

            if (format.StringOption.IsSet && format.StringOption.Value != null)
                writer.WriteString("Metadata", format.StringOption.Value);

            WriteProperties(writer, format, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Format" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="format"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Format format, JsonSerializerOptions jsonSerializerOptions)
        {
