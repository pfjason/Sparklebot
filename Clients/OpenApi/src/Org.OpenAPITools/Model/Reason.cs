...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Reason : IValidatableObject
    {
        ...
        internal Reason(Option<string?> @string)
        {
            StringOption = @string;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Reason" />
    /// </summary>
    public class ReasonJsonConverter : JsonConverter<Reason>
    {
        /// <summary>
        /// Deserializes json to <see cref="Reason" />
        /// </summary>
        ...
        public override Reason Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Reason(varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Reason" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="reason"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Reason reason, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (reason.StringOption.IsSet && reason.StringOption.Value != null)
                writer.WriteString("Reason", reason.StringOption.Value);

            WriteProperties(writer, reason, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Reason" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="reason"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Reason reason, JsonSerializerOptions jsonSerializerOptions)
        {
