...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Hash : IValidatableObject
    {
        ...
        internal Hash(Option<string?> @string)
        {
            StringOption = @string;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Hash" />
    /// </summary>
    public class HashJsonConverter : JsonConverter<Hash>
    {
        /// <summary>
        /// Deserializes json to <see cref="Hash" />
        /// </summary>
        ...
        public override Hash Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Hash(varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Hash" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="hash"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Hash hash, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (hash.StringOption.IsSet && hash.StringOption.Value != null)
                writer.WriteString("Reason", hash.StringOption.Value);

            WriteProperties(writer, hash, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Hash" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="hash"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Hash hash, JsonSerializerOptions jsonSerializerOptions)
        {
