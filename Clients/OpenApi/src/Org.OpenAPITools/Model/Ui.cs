...
namespace Org.OpenAPITools.Model
{
    ...
    /// Ui
    /// </summary>
    public partial class Ui : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Ui" /> class.
        /// </summary>
        /// <param name="object"></param>
        internal Ui(Option<Object?> @object)
        {
            ObjectOption = @object;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Ui" />
    /// </summary>
    public class UiJsonConverter : JsonConverter<Ui>
    {
        /// <summary>
        /// Deserializes json to <see cref="Ui" />
        /// </summary>
        ...
        public override Ui Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Ui(varObjectParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Ui" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="ui"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Ui ui, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (ui.ObjectOption.IsSet && ui.ObjectOption.Value != null)

            WriteProperties(writer, ui, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Ui" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="ui"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Ui ui, JsonSerializerOptions jsonSerializerOptions)
        {
