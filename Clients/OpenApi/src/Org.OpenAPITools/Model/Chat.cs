...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Chat : IValidatableObject
    {
        ...
        internal Chat(Option<Object?> @object)
        {
            ObjectOption = @object;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Chat" />
    /// </summary>
    public class ChatJsonConverter : JsonConverter<Chat>
    {
        /// <summary>
        /// Deserializes json to <see cref="Chat" />
        /// </summary>
        ...
        public override Chat Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Chat(varObjectParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Chat" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="chat"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Chat chat, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (chat.ObjectOption.IsSet && chat.ObjectOption.Value != null)

            WriteProperties(writer, chat, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Chat" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="chat"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Chat chat, JsonSerializerOptions jsonSerializerOptions)
        {
