...
namespace Org.OpenAPITools.Model
{
    ...
    /// Description
    /// </summary>
    public partial class Description : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Description" /> class.
        /// </summary>
        /// <param name="string"></param>
        internal Description(Option<string?> @string)
        {
            StringOption = @string;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Description" />
    /// </summary>
    public class DescriptionJsonConverter : JsonConverter<Description>
    {
        /// <summary>
        /// Deserializes json to <see cref="Description" />
        /// </summary>
        ...
        public override Description Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Description(varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Description" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="description"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Description description, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (description.StringOption.IsSet && description.StringOption.Value != null)
                writer.WriteString("Reason", description.StringOption.Value);

            WriteProperties(writer, description, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Description" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="description"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Description description, JsonSerializerOptions jsonSerializerOptions)
        {
