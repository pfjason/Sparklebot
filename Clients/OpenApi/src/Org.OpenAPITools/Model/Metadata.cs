...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Metadata : IValidatableObject
    {
        ...
        internal Metadata(Option<Object?> @object, Option<string?> @string)
        {
            ObjectOption = @object;
            StringOption = @string;
            OnCreated();
    ...
    public class MetadataJsonConverter : JsonConverter<Metadata>
    {
        ...
        public override Metadata Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Metadata(varObjectParsedValue, varStringParsedValue);
        }
        ...
        public override void Write(Utf8JsonWriter writer, Metadata metadata, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (metadata.ObjectOption.IsSet && metadata.ObjectOption.Value != null)

            if (metadata.StringOption.IsSet && metadata.StringOption.Value != null)
                writer.WriteString("Metadata", metadata.StringOption.Value);
