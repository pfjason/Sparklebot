...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Capabilities : IValidatableObject
    {
        ...
        internal Capabilities(Option<Object?> @object)
        {
            ObjectOption = @object;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Capabilities" />
    /// </summary>
    public class CapabilitiesJsonConverter : JsonConverter<Capabilities>
    {
        /// <summary>
        /// Deserializes json to <see cref="Capabilities" />
        /// </summary>
        ...
        public override Capabilities Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Capabilities(varObjectParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Capabilities" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="capabilities"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Capabilities capabilities, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (capabilities.ObjectOption.IsSet && capabilities.ObjectOption.Value != null)

            WriteProperties(writer, capabilities, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Capabilities" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="capabilities"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Capabilities capabilities, JsonSerializerOptions jsonSerializerOptions)
        {
