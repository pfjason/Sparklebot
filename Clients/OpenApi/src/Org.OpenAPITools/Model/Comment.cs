...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Comment : IValidatableObject
    {
        ...
        internal Comment(Option<string?> @string)
        {
            StringOption = @string;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Comment" />
    /// </summary>
    public class CommentJsonConverter : JsonConverter<Comment>
    {
        /// <summary>
        /// Deserializes json to <see cref="Comment" />
        /// </summary>
        ...
        public override Comment Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Comment(varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Comment" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, Comment comment, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (comment.StringOption.IsSet && comment.StringOption.Value != null)
                writer.WriteString("Reason", comment.StringOption.Value);

            WriteProperties(writer, comment, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Comment" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="comment"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Comment comment, JsonSerializerOptions jsonSerializerOptions)
        {
