...
namespace Org.OpenAPITools.Model
{
    ...
    /// AuthType
    /// </summary>
    public partial class AuthType : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuthType" /> class.
        /// </summary>
        /// <param name="string"></param>
        internal AuthType(Option<string?> @string)
        {
            StringOption = @string;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="AuthType" />
    /// </summary>
    public class AuthTypeJsonConverter : JsonConverter<AuthType>
    {
        /// <summary>
        /// Deserializes json to <see cref="AuthType" />
        /// </summary>
        ...
        public override AuthType Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AuthType(varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="AuthType" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="authType"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, AuthType authType, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (authType.StringOption.IsSet && authType.StringOption.Value != null)
                writer.WriteString("Reason", authType.StringOption.Value);

            WriteProperties(writer, authType, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="AuthType" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="authType"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, AuthType authType, JsonSerializerOptions jsonSerializerOptions)
        {
