...
namespace Org.OpenAPITools.Model
{
    ...
    /// ModelId
    /// </summary>
    public partial class ModelId : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelId" /> class.
        /// </summary>
        /// <param name="string"></param>
        internal ModelId(Option<string?> @string)
        {
            StringOption = @string;
            OnCreated();
        }
    ...
    {
        /// <summary>
        /// Deserializes json to <see cref="ModelId" />
        /// </summary>
        ...
        public override ModelId Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new ModelId(varStringParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="ModelId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, ModelId modelId, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (modelId.StringOption.IsSet && modelId.StringOption.Value != null)
                writer.WriteString("Reason", modelId.StringOption.Value);

            WriteProperties(writer, modelId, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ModelId" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="modelId"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, ModelId modelId, JsonSerializerOptions jsonSerializerOptions)
        {
