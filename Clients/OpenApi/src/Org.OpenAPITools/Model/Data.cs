...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Data : IValidatableObject
    {
        ...
        internal Data(Option<Object?> @object)
        {
            ObjectOption = @object;
            OnCreated();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="Data" />
    /// </summary>
    public class DataJsonConverter : JsonConverter<Data>
    {
        /// <summary>
        /// Deserializes json to <see cref="Data" />
        /// </summary>
        ...
        public override Data Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Data(varObjectParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Data" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="data"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Data data, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (data.ObjectOption.IsSet && data.ObjectOption.Value != null)

            WriteProperties(writer, data, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Data" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="data"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Data data, JsonSerializerOptions jsonSerializerOptions)
        {
